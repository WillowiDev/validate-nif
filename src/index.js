...
export function validateNif(value) {
  ...
  if ((i1 === 1) && (caracEnCad(CHARS_CIF, arrayOfChar[i2])) &&
    (i2 === 0) && !Number.isNaN(parseInt(arrayOfChar[8], 10))) {
    for (let i = 1; i < 8; i += 1) {
      if ((i === 2) || (i === 4) || (i === 6)) {
        k += arrayOfChar[i] - '0';
      } else {
  ...
  if ((i1 === 2) && (caracEnCad(CHARS_CIFORG_Y_EXTR, arrayOfChar[i2])) &&
    (i2 === 0) && (i3 === 8) && (caracEnCad(CHARS_2CIF, arrayOfChar[i3]))) {
    for (let i = 1; i < 8; i += 1) {
      if ((i === 2) || (i === 4) || (i === 6)) {
        k += arrayOfChar[i] - '0';
      } else {
  ...
  if ((i1 === 1) && (caracEnCad(CHARS, arrayOfChar[8])) &&
    (caracEnCad(CHARS_NIF, arrayOfChar[i2])) && (i2 === 8)) {
  ...
  if ((i1 === 2) && (caracEnCad(CHARS_NIFEXT, arrayOfChar[0])) &&
    (caracEnCad(CHARS_NIF, arrayOfChar[i3])) && (i3 === 8)) {
    str = paramString.substring(1, i3);
    l1 = parseInt(str, 10);
    if (arrayOfChar[0] === 'Y') {
      l1 += 10000000;
